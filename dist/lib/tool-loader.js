...
export async function loadLocalTools() {
    ...
    for (const file of files) {
        try {
            ...
            console.warn(`[Tools] Failed to load local/tools/${file}:`, err.message);
        }
    }
    return tools;
}
/** Dynamically import a single tool file and return the Tool object. */
export async function loadSingleTool(filePath) {
...
export function getLocalToolsDir() {
